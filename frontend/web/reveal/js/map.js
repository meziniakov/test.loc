(function ($) {
    ...
    function mainMap() {
        ...
        var locations = [
            [locationData('single-property-2.html', 'https://via.placeholder.com/1200x850', '$125 - $150', 'Event', 'Name'), 40.72956781, -73.99726866, 0, markerIcon,],
        ...
        // var lineChartData = '<?php echo var_dump($listing); ?>';
