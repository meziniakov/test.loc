...
<?= MessageFormWidget::widget([]); ?>
						...
						<div class="col-lg-4 col-md-4 col-sm-12">
							<div class="autor-bio-wrap">
								...
								<div class="author-thumb">
									...
									<div class="author-thumb-caption">
                                    <li class="log-icon lg-ic"><a href="#" data-toggle="modal" data-target="#message" class="rt-log">Отправить Email</a></li>
                                    <li class="log-icon lg-ic"><a href="#" data-toggle="modal" data-target="#passwd" class="rt-log">Сменить пароль</a></li>
							...
							<div class="tab-content" id="author-tabContent">
								...
								<div class="tab-pane fade show active" id="author-about" role="tabpanel" aria-labelledby="author-about-tab">
									...
									<div class="block-wrap">
                                        ...
                                        <?= $form->field($user, 'avatar_path')->widget(FileApi::class, [
                                            'settings' => [
                                        ...
                                        <?= $form->field($user, 'other')->textarea(['rows' => 6]) ?>
					...
					<div class="modal-content" id="message">
						...
						<div class="modal-body">
                            ...
                            <?php $form = ActiveForm::begin() ?>
                                ...
                                <?= $form->field($message, 'body')->textArea(['rows' => 6]) ?>
			...
			<!-- End Modal -->
            <!-- Sign Up Modal -->
			<div class="modal fade" id="passwd" tabindex="-1" role="dialog" aria-labelledby="passwd">
				<div class="modal-dialog modal-dialog-centered login-pop-form" role="document">
					<div class="modal-content" id="passwd">
						<span class="mod-close" data-dismiss="modal"><i class="ti-close"></i></span>
						<div class="modal-body">
							<div class="login-form">
                            <?php $form = ActiveForm::begin() ?>

<?= $form->field($passwd, 'password')->passwordInput(['maxlength' => true]) ?>

<?= $form->field($passwd, 'password_confirm')->passwordInput(['maxlength' => true])?>
