    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'filter' => ArrayHelper::map(PlaceCategory::find()->noParents()->all(), 'id', 'title'),
            ],
            [
                'attribute' => 'status',
                'format' => 'html',
                ...
                'filter' => [
                    PlaceCategory::STATUS_DRAFT => Yii::t('backend', 'Not active'),
                    PlaceCategory::STATUS_ACTIVE => Yii::t('backend', 'Active'),
                ],
            ],
            // 'created_at',
            // 'updated_at',
